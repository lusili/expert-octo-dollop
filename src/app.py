...
activities = {
    ...
    "Swimming Team": {
        "description": "Practice strokes, improve endurance, and compete in meets",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["sarah@mergington.edu", "liam@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Team drills, friendly games, and skill development",
    ...
    "Drama Workshop": {
        "description": "Acting exercises, scene work, and stagecraft fun",
